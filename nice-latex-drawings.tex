...
\begin{document}
    ...
    \begin{minipage}{\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \node[circle, draw, inner sep=0.5mm] (1) at (-0.25, -1.5) {};
            \draw (0) -- (1);
            \node[circle, draw, inner sep=0.5mm] (2) at (-0.5, -1.75) {};
            \node[circle, draw, inner sep=0.5mm] (3) at (0, -1.75) {};
            \draw (1) -- (2);
            \draw (1) -- (3);
            \node at (1, -1) {\(\leadsto\)};
            \coordinate (4) at (1.75, -1);
            \draw (2, 0) -- (2.5,-1) -- (1.5,-1) -- (2, 0);
            \node[circle, draw, inner sep=0.5mm] (5) at (1.75, -1.5) {};
            \draw (4) -- (5);
            \node[circle, draw, inner sep=0.5mm] (6) at (1.5, -1.75) {};
            \node[circle, draw, inner sep=0.5mm] (7) at (2, -1.75) {};
            \draw (5) -- (6);
            \draw (5) -- (7);
            \node[circle, draw, inner sep=0.5mm] (8) at (1.75, -2) {};
            \node[circle, draw, inner sep=0.5mm] (9) at (2.25, -2) {};
            \draw (7) -- (8);
            \draw (7) -- (9);
        \end{tikzpicture}
    \end{minipage}
    ...
    \begin{minipage}{\linewidth}
        ...
        \begin{tikzpicture}[
            ...
            \draw[dashed] plot[smooth, tension=1] coordinates { (s) (-0.75, 1.25) (-2.75, -0.75) (-0.5, -1.25) (0.75, -0.25) (t) };
        \end{tikzpicture}
    \end{minipage}
\end{document}
