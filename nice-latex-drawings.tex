...
\begin{document}
    ...
    \begin{minipage}{\linewidth}
        ...
        \begin{tikzpicture}[
            ...
            \draw[->] (0, 0) -- (2.83, 0) node[below, pos=0.5] {\(\cos{\phi}\)};
            \draw[->] (0, 0) -- (0, 2.83) node[right, pos=0.5, rotate=270, anchor=south] {\(\cos{\phi}\)};
            \draw (2.83, 2.83) -- (2.83, 0) node[right, pos=0.5, rotate=270, anchor=south] {\(\sin{\phi}\)};
            \draw (-2.83, 2.83) -- (0, 2.83) node[above, pos=0.5] {\(-\sin{\phi}\)};
